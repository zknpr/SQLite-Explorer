 ...
 * Composes all sections: Hero, Features, Installation, and Footer.
 *
 * This is a static page (no dynamic data) for optimal performance.
 */

import { Hero, Features, Installation, Footer } from '@/components';
...
export default function Home() {
  return (
    <main className="min-h-screen">
      {/* Above the fold: Hero with headline, CTAs, and mockup */}
      <Hero />
